...
import numpy as np
from utils.polygon_interacter import PolygonInteractor
from matplotlib.patches import Polygon
from utils.pyimagesearch import imutils, transform
...
class DocScanner(object):
    ...
    def filter_corners(self, corners, min_dist=20):
        ...
        def predicate(representatives, corner):
            return all(
                euclidean(representative, corner) >= min_dist
